...
class Board:
    """
    The code defines a Board class for a Minesweeper game and a play function to interact with the game
    board.

    :param dim_size: The 'dim_size' parameter represents the dimension size of the board, indicating the
    number of rows and columns in the board. It determines the size of the square board where the game
    will be played, defaults to 10 (optional)
    :param num_bombs: The 'num_bombs' parameter specifies the number of bombs that will be randomly
    placed on the game board. This parameter determines the level of difficulty in the game as the
    player needs to avoid digging on bomb locations to win, defaults to 10 (optional)
    """
